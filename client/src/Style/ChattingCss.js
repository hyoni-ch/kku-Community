...
const PostNoneDiv = styled.div`
  ...
  text-align: center;
`
export { ModalBackdrop, PostingWriteTitle, PostSpan, Wrapper, LoginForm, ChattingWrapper, ChattingListImg, ChattingListTextWrapper, ChattingListText, PostNone, PostNoneDiv }