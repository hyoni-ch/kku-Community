    ...
    <div className="main">
      ...
      <PostDiv>
        ...
        <Post>
          ...
          <p style={{marginTop:'2vh', fontSize: '1.1rem', whiteSpace: 'pre-line',}} >{props.PostInfo.content}</p>
        </Post>
          ...
          <BtnDiv>
            ...
            {user.uid === props.PostInfo.author.uid && (
              <>
              <Link to={`/askEdit/${props.PostInfo.postNum}`}>
